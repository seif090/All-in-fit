...
# ===== Map options =====
Write-File "$base\Maps\MapServiceOptions.cs" @'
...
# ===== OSRM category mapping =====
Write-File "$base\Maps\OsmCategoryMapper.cs" @'
...
# ===== Map service (Nominatim + OSRM + Overpass) =====
Write-File "$base\Maps\OpenStreetMapService.cs" @'
...
Write-Host "Infrastructure maps layer generated successfully!"
