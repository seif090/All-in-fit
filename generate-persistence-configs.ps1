...
Write-File "$base\Identity\RoleConfiguration.cs" @'
using AllInFit.Domain.Entities.Identity;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;
...
public sealed class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        builder.HasIndex(e => e.Sku).IsUnique().HasDatabaseName("IX_Products_Sku").HasFilter("[Sku] IS NOT NULL");
...
public sealed class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.Property(e => e.PaymentStatus).HasConversion<string>().HasMaxLength(50);
        builder.Property(e => e.RowVersion).IsRowVersion();
    }
}
'@
...
public sealed class WalletTransactionConfiguration : IEntityTypeConfiguration<WalletTransaction>
{
    public void Configure(EntityTypeBuilder<WalletTransaction> builder)
    {
        ...
        builder.Property(e => e.BalanceBefore).HasColumnType("decimal(18,2)").IsRequired();
...
public sealed class AppointmentConfiguration : IEntityTypeConfiguration<Appointment>
{
    public void Configure(EntityTypeBuilder<Appointment> builder)
    {
        ...
        builder.Property(e => e.RowVersion).IsRowVersion();
        builder.HasIndex(e => new { e.ProviderId, e.StartTime }).HasDatabaseName("IX_Appointments_Provider_Start");
    }
}
'@
...
Write-Host "Entity configurations generated successfully!"
