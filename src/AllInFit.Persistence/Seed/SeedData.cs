...
var roles = new List<Role>
            {
                new("SuperAdmin", "Full system access"),
                new("Admin", "Administrative access"),
                new("User", "Standard platform user"),
                new("GymOwner", "Gym management access"),
                new("Trainer", "Training professional"),
                new("Doctor", "Medical professional"),
                new("Nutritionist", "Nutrition professional"),
                new("RestaurantOwner", "Restaurant management"),
                new("PharmacyOwner", "Pharmacy management"),
                new("SupplementSeller", "Supplement marketplace seller")
            };
