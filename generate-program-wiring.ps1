$programPath = "c:\Users\seaif\Desktop\All in fit\src\AllInFit.Presentation\Program.cs"
...
Write-Host "Program.cs rewritten with SignalR + Hangfire + rate limiting wiring."

# =====================================================================
# appsettings.json — add Hangfire + RateLimiting sections
# =====================================================================
$settingsPath = "c:\Users\seaif\Desktop\All in fit\src\AllInFit.Presentation\appsettings.json"
$settings = @'
{
  "Logging": {
    "LogLevel": {
...
'@
[System.IO.File]::WriteAllText($settingsPath, $settings, [System.Text.Encoding]::UTF8)
Write-Host "appsettings.json updated with Hangfire + RateLimiting sections."
