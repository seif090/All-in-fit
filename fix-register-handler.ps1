...
$path = "c:\Users\seaif\Desktop\All in fit\src\AllInFit.Application\Commands\Auth\Handlers\RegisterCommandHandler.cs"
...
Write-Host "Fixed RegisterCommandHandler.cs"
